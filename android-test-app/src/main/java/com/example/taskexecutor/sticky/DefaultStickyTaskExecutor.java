...
public class DefaultStickyTaskExecutor<T> implements StickyTaskExecutor<T> {

    private static final String TAG = DefaultStickyTaskExecutor.class.getSimpleName();
    ...
    public DefaultStickyTaskExecutor(TaskExecutor<T> taskExecutor) {
    ...
    @Override
    public void unregisterLastListener() {
    ...
    private class ProxyListener extends DefaultTaskExecutionListener<T> {
        @Override
